...
NOTE: What is this plug in for?  What is it doing?  When does it do it?  Why is it important?
...
14. After the application has successfully deployed, create another EC2 called "Monitoring".  Install Prometheus and Grafana and then configure it to monitor the activity on the server running the application. 
